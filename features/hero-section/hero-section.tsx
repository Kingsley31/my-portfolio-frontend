...
export function HeroSection() {
    ...
    return (
        <div className="relative px-4 md:px-10 lg:px-20 h-dvh pt-15 md:pt-0 overflow-y-auto w-full overflow-x-hidden">
            <HeroContent>
                ...
                <div className="flex flex-col justify-between md:justify-start basis-sm md:basis-[408px] pt-0">
                    ...
                    <div>
                        <p className="text-2xl mx-auto md:mx-0 text-center md:text-left md:text-5xl font-bold mt-4 md:mt-6 text-primary">Software Engineer</p>
