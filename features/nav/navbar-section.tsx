...
export function NavBarSection() {
    ...
    return (
        <div className="fixed w-full max-w-6xl top-0 pr-0 md:pr-4  z-100">
        <div className="flex flex-row items-center justify-between w-full max-w-6xl mx-auto px-4 md:px-10 lg:px-20 bg-white h-20">
